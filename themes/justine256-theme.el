...
(let ((class '((class color) (min-colors 89)))
      ...
      (cham-1 "#8ae234") (cham-2 "#73d216") (cham-3 "#4e9a06") (cham-4 "#005f00")
  ...
  (custom-theme-set-faces
   ...
   `(diff-added ((,class (:background ,cham-1 :foreground ,cham-4))))
   `(diff-refine-added ((,class (:background ,cham-0 :foreground ,cham-4))))
   `(diff-removed ((,class (:background ,red-0 :foreground ,red-4))))
   `(diff-refine-removed ((,class (:background ,red-1 :foreground ,red-4))))
